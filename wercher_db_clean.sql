...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2020 at 02:28 AM
...
INSERT INTO `admin` (`AdminNo`, `Image`, `Permissions`, `Position`, `AdminID`, `Password`, `FirstName`, `MiddleName`, `LastName`, `Gender`, `DateAdded`, `DateRemoved`, `Notes`, `Status`) VALUES
(23, 0x687474703a2f2f6c6f63616c686f73742f63695f776572636865725f73797374656d2f6173736574732f696d672f776572636865725f6e6f696d6167655f626c75652e706e67, 'Dashboard,DashboardLogbook,Applicants,ApplicantsEditing,ApplicantsExpired,ApplicantsBlacklisted,ApplicantsArchived,Employees,EmployeesHiring,EmployeesEditing,EmployeesRegulars,Admins,AdminsEditing,AdminsArchived,Clients,ClientsEditing,ClientsArchived,Payroll', 'Developer', 'admin', '$2y$10$9PcF.PxnXgMi1A4cLz6ILepOFYLdA.mpHWXu4Wms8.aGiSBaqJWxC', '', '', '', NULL, '2020-11-27 09:14:17', NULL, 'super admin', 'Active');
...
(1, 'test2', '1', '1', 'test', '2020-11-28 06:45:52 AM', 'Active'),
...
--
ALTER TABLE `admin`
  MODIFY `AdminNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
