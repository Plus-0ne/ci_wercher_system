				...
				<div class="row rcontent p-5 PrintOut">
					...
					<div class="col-6 col-sm-6 col-md-6 mb-5 PrintExclude">
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $PositionDesired; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $SalaryExpected; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $ApplicantID; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $LastName; ?> , <?php echo $FirstName; ?>  <?php echo $MiddleInitial; ?>.">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $Gender; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $Age; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $Height; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $Weight; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $Religion; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
						...
						<div class="col-sm-12 col-md-4 e-det">
							<p>
								<input type="text" name="Modify_PositionDesired" value="<?php echo $BirthDate; ?>">
							</p>
						</div>
						<div class="col-sm-12 col-md-2 e-title">
							<h6>
