			...
			<div class="container-fluid">
				...
				<?php else: 
					if ($this->Model_Security->CheckPermissions('Applicants')): ?>
						...
						<?php endif; ?>
					<?php endif; ?>
					<?php if ($this->Model_Security->CheckPermissions('Employees')): ?>
						...
						<?php endif; ?>
					<?php endif; ?>
					<?php if ($this->Model_Security->CheckPermissions('Applicants')): ?>
						...
						<?php endif; ?>
					<?php endif; ?>
					<?php if ($this->Model_Security->CheckPermissions('Clients')): ?>
					...
					<?php if ($this->Model_Security->CheckPermissions('Applicants')): ?>
						...
						<?php endif; ?>
					<?php endif; ?>
					<?php if ($this->Model_Security->CheckPermissions('Admins')): ?>
										...
										<tbody>
											<?php foreach ($SearchAdmins->result_array() as $row): ?>
												<tr>
													...
													<td class="text-center align-middle PrintExclude" width="110">
														<a class="btn btn-primary btn-sm w-100 mb-1" href="<?=base_url() . 'Logbook?admin=' . $row['AdminID'];?>"><i class="far fa-eye"></i> View</a>
													</td>
												</tr>
											<?php endforeach; ?>
										</tbody>
