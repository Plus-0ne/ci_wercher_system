		...
		<div id="content" class="ncontent">
			<div class="container-fluid">
				...
				<div class="col-12 col-sm-12 tabs">
					<ul>
						<li><a href="<?php echo base_url() ?>Clients">Clients (<?php echo $ShowClients->num_rows()?>)</a></li>
						<li class="tabs-active"><a href="<?php echo base_url() ?>ClientsArchived">Archived</a></li>
					</ul>
				</div>
				<div class="row rcontent">
					<div class="col-5 PrintPageName PrintOut">
						<i class="fas fa-info-circle"></i>
						<i>Found <?php echo $ShowClients->num_rows(); ?> client<?php if($ShowClients->num_rows() != 1): echo 's'; endif;?> archived in the database.
						</i>
					</div>
								...
								<tbody>
									<?php foreach ($ShowClients->result_array() as $row): 
										...
										<tr class="text-center align-middle table-row-hover">
											...
											<td class="text-center align-middle d-none">
												<?php echo $archivedDay . ' at ' . $archivedHours; ?>
											</td>
											<?php else: ?>
											<td>
												<i style="color: gray;">No record.</i>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$(".nav-item a[href*='Clients']").addClass("nactive");
		// =====================
