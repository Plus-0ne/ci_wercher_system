...
$GetPayrollLoans = $this->Model_Selects->GetAllPayrollLoans();
			...
			<div class="container-fluid">
				...
				<div class="col-12 col-sm-12 tabs">
					<ul>
						...
						<li class="tabs-active"><a href="<?php echo base_url() ?>Loans">Loans</a></li>
					...
					<div class="col-sm-12">
						<div class="table-responsive pt-2 pl-2 pr-2">
							<table id="ListClients" class="table PrintOut" style="width: 100%;">
								...
								<tbody>
									<?php foreach ($GetPayrollLoans->result_array() as $row): 
										$name = $row['LoanName'] ?? 'N/A';
