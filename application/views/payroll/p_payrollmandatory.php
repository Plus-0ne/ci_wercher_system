			...
			<div class="container-fluid">
				...
				<div class="col-12 col-sm-12 tabs">
					<ul>
						...
						<li class="tabs-active"><a href="<?php echo base_url() ?>PayrollMandatoryDed">Mandatory Ded.</a></li>
							...
							<table id="ListClients" class="table PrintOut" style="width: 100%;">
								<thead>
									<tr class="text-center">
										...
										<th class="grosspayfortax-group"></th>
										<th class="grosspay-group"></th>
										<th class="basetax-group"></th>
										<th class="tax-group"></th>
										<th class="remittances-group" colspan="3">REMITTANCES</th>
										<th class="loans-group" colspan="4">LOANS</th>
										<th class="totaldeduction-group"></th>
										<th class="netlaborcost-group"></th>
									</tr>
									<tr class="align-middle">
										<th class="name-group" style="width: 300px;">NAME</th>
										<th class="rate-group" style="width:">RATE</th>
										<th class="grosspayfortax-group">GROSS PAY FOR TAX</th>
										<th class="grosspay-group">GROSS PAY</th>
										<th class="basetax-group">BASE (TAX)</th>
										<th class="tax-group">TAX</th>
										<!-- remittances -->
										<th class="remittances-group">SSS</th>
										<th class="remittances-group">PHILHEALTH</th>
										<th class="remittances-group">PAG-IBIG</th>
										<!-- loans -->
										<th class="loans-group">SSS MPI</th>
										<th class="loans-group">SSS CAI</th>
										<th class="loans-group">PAG-IBIG MPI</th>
										<th class="loans-group">PAG-IBIG CAI</th>

										<th class="totaldeduction-group">TOTAL DEDUCTION</th>
										<th class="netlaborcost-group">NET LABOR COST</th>
									</tr>
								</thead>
								<tbody>
									...
									?>
										<tr class="table-row-hover">
											...
											<td class="grosspayfortax-group text-center align-middle">
												TBD
											</td>
											<td class="grosspay-group text-center align-middle">
												<?php
													echo $GrossPayTotal;
												?>
											</td>
											<td class="basetax-group text-center align-middle">
												TBD
											</td>
											<td class="tax-group text-center align-middle">
												TBD
											</td>
											<!-- remittances -->
											<td class="remittances-group text-center align-middle">
												TBD
											</td>
											<td class="remittances-group text-center align-middle">
												TBD
											...
											<!-- loans -->
											<td class="loans-group text-center align-middle">
												TBD
											</td>
											<td class="loans-group text-center align-middle">
												TBD
											...
											<td class="totaldeduction-group text-center align-middle">
												TBD
											</td>
											<td class="netlaborcost-group text-center align-middle">
												TBD
											</td>
										</tr>
									<?php endforeach ?>
