...
/**
 *    simplexlxs php class v0.8.9
 *    MS Excel 2007 workbooks reader
 *
 * Copyright (c) 2012 - 2019 simplexlxs
 *
 * @category   simplexlxs
 * @package    simplexlxs
 * @copyright  Copyright (c) 2012 - 2019 simplexlxs (https://github.com/shuchkin/simplexlxs/)
 * @license    MIT
 * @version    0.8.9
 */
 ...
 *
 * Example 1:
 * if ( $xlsx = simplexlxs::parse('book.xlsx') ) {
 *   print_r( $xlsx->rows() );
 * } else {
 *   echo simplexlxs::parseError();
 * }
 *
 ...
 *
 * Example 3: rowsEx
 * $xlsx = simplexlxs::parse('book.xlsx');
 * print_r( $xlsx->rowsEx() );
 *
 ...
 *
 * Example 8: read data
 * if ( $xlsx = simplexlxs::parse( file_get_contents('http://www.example.com/example.xlsx'), true) ) {
 ...
 * v0.8.5 (2019-03-07) simplexlxs::ParseErrno(), $xlsx->errno() returns error code
 ...
 * v0.8.1 (2018-11-07) rename simplexlxs.php to simplexlxs.php, rename parse_error to parseError fix _columnIndex, add ->toHTML(), GNU to MIT license
